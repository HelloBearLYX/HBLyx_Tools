...
function GUI.TagPanels.WarlockReminder:CreateTabPanel(parent)
	...
	GUI:CreateSlider(frame, L["IconSize"], 10, 200, 1, addon.db.WarlockReminders.IconSize, function(value)
		addon.db.WarlockReminders.IconSize = value
		update()
	end)
	GUI:CreateSlider(frame, L["IconZoom"], 0.01, 0.5, 0.01, addon.db.WarlockReminders.IconZoom, function(value)
		addon.db.WarlockReminders.IconZoom = value
		update()
	end)
	GUI:CreateFontSelect(frame, L["Font"], addon.db.WarlockReminders.Font, function(value)
		addon.db.WarlockReminders.Font = value
		update()
	end)
	GUI:CreateSlider(frame, L["FontSize"], 6, 40, 1, addon.db.WarlockReminders.FontSize, function(value)
		addon.db.WarlockReminders.FontSize = value
		update()
	end)

	GUI:CreateHeader(frame, L["PetSettings"])
	GUI:CreateToggleCheckBox(frame, L["Enable"], addon.db.WarlockReminders.PetEnabled, function(value)
		addon.db.WarlockReminders.PetEnabled = value
		addon:ShowDialog(ADDON_NAME.."RLNeeded")
	end)
	GUI:CreateToggleCheckBox(frame, L["PetStanceEnable"], addon.db.WarlockReminders.StanceEnabled, function(value)
		addon.db.WarlockReminders.StanceEnabled = value
	end)
	GUI:CreateSlider(frame, L["X"], -2000, 2000, 1, addon.db.WarlockReminders.PetX, function(value)
		addon.db.WarlockReminders.PetX = value
		update()
	end)
	GUI:CreateSlider(frame, L["Y"], -1000, 1000, 1, addon.db.WarlockReminders.PetY, function(value)
		addon.db.WarlockReminders.PetY = value
		update()
	end)

	GUI:CreateHeader(frame, L["PetTypeSettings"])
	GUI:CreateToggleCheckBox(frame, L["FelguardEnable"], addon.db.WarlockReminders.FelguardEnabled, function(value)
		addon.db.WarlockReminders.FelguardEnabled = value
	end)
	GUI:CreateToggleCheckBox(frame, L["FelhunterEnable"], addon.db.WarlockReminders.FelhunterEnabled, function(value)
		addon.db.WarlockReminders.FelhunterEnabled = value
	end)

	GUI:CreateHeader(frame, L["CandySetting"])
	GUI:CreateToggleCheckBox(frame, L["Enable"], addon.db.WarlockReminders.CandyEnabled, function(value)
		addon.db.WarlockReminders.CandyEnabled = value
		addon:ShowDialog(ADDON_NAME.."RLNeeded")
	end)
	GUI:CreateSlider(frame, L["X"], -2000, 2000, 1, addon.db.WarlockReminders.CandyX, function(value)
		addon.db.WarlockReminders.CandyX = value
		update()
	end)
	GUI:CreateSlider(frame, L["Y"], -1000, 1000, 1, addon.db.WarlockReminders.CandyY, function(value)
