...
local function CreateGeneralPanel(container)
    ...
    local wagoRelease = AceGUI:Create("InteractiveLabel")
    wagoRelease:SetText("|TInterface\\AddOns\\HBLyx_tools\\Media\\Wago.png:20:20|t |cFF8080FFWago|r")
    wagoRelease:SetFont("Fonts\\FRIZQT__.TTF", 12, "OUTLINE")
    wagoRelease:SetJustifyV("MIDDLE")
    wagoRelease:SetRelativeWidth(0.25)
    wagoRelease:SetCallback("OnClick", function() addon.Utilities:OpenURL("Wago", "https://addons.wago.io/addons/hblyx-tools") end)
    wagoRelease:SetCallback("OnEnter", function() wagoRelease:SetText("|TInterface\\AddOns\\HBLyx_tools\\Media\\Wago.png:20:20|t |cFFFFFFFFWago|r") end)
    wagoRelease:SetCallback("OnLeave", function() wagoRelease:SetText("|TInterface\\AddOns\\HBLyx_tools\\Media\\Wago.png:20:20|t |cFF8080FFWago|r") end)
    releaseGroup:AddChild(wagoRelease)
    -- change log
